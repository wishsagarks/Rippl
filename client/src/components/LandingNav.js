    ...
    <div>
        <ul className=' text-[#EDCB87] gap-10 bg-black text-lg md:w-[100vw] py-8
         poppins relative z-10 items-right landing-nav pl-10 hidden md:flex'>
            ...
            <li className='cursor-pointer' onClick={()=>{nav("/signup")}}>User Sign Up</li>
            <li className='cursor-pointer absolute right-48 px-5' onClick={()=>{nav("/adminlogin")}}>Admin Login</li>
            <li className='cursor-pointer absolute right-10 px-5' onClick={()=>{nav("/adminsignup")}}>Admin SignUp</li>
        </ul>
    </div>
  )
}
