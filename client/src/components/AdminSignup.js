    ...
    <div className="h-screen w-full public-route-bg overflow-hidden">
      ...
      />
        <div className="flex flex-col items-center gap-16 pt-16 lg:ml-48 xl:ml-0 relative z-10 xl:pl-96 ">
          <h1 className="poppins text-[#E0AA71] font-bold md:text-5xl text-xl">
            ADMIN SIGN UP
          </h1>
          <form
          ...
          >
            <input
              ...
              className="bg-[#EBC990] rounded-lg p-2 px-10 text-[#000] placeholder-slate-600 poppins "
            />
            <input
              onChange={(e) => {
            ...
            <button
              type="submit"
              className="submit-button rounded-full py-2 w-48 font-bold text-lg"
            >
              Submit
            </button>

            <div className="text-white">Already a creator? <span className="cursor-pointer text-[#e0aa71] font-semibold"
            onClick={(e)=>{
              e.preventDefault()
              window.location.href="/adminlogin"
            }}
