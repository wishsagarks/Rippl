    ...
    <div className='h-screen w-full public-route-bg overflow-hidden'>
      ...
      />
        <div className='flex flex-col items-center gap-16 pt-16 lg:ml-48 xl:ml-0 relative z-10 xl:pl-96 '>
          ...
          <h1 className='poppins text-[#E0AA71] font-bold md:text-5xl text-xl'>USER LOGIN</h1>
          <form action="signup" className='flex flex-col gap-10  items-center' onSubmit={handleSubmit}>
            ...
            <div className="text-white">Not a user? <span className="cursor-pointer text-[#e0aa71] font-semibold"
            onClick={(e)=>{
              e.preventDefault()
